...
/// <summary>
/// Catálogo de cultivos desde YarqtbCultivo.
/// </summary>
public sealed class CropCatalogService : ICropCatalogService
{
    ...
    public CropCatalogService(YarquaDbContext db)
    {
        _db = db;
    }
    ...
    private static CropDto ToDto(YarqtbCultivo c) => new()
    {
        Id = c.CultId,
        Name = c.CultNombre,
