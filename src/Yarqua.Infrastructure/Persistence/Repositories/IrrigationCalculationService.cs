...
public sealed class IrrigationCalculationService : IIrrigationCalculationService
{
    ...
    public IrrigationCalculationService(YarquaDbContext db)
    {
        _db = db;
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var entity = new YarqtbCalculoRiego
        {
            UsuaId = userId,
    ...
    private static IrrigationCalculationDto ToDto(YarqtbCalculoRiego c) => new()
    {
        Id = c.CalcId,
